...
public class Jedi extends Protagonista {
	...
	protected void setScenari() {
		...
		scenari[0]="Ti trovi sul pianeta KeltHat, il primo dei 3 pianeti più pericolosi dell’universo, questo pianeta ospita tutti i mostri più strani e potenti di tutto il cosmo.\n "
		...
		scenari[2]="Tu e i tuoi compagni siete atterrati su Felucia con le vostre nuovissime e potentissime spade laser,\n "
				...
				"1. Ti prenoti per prima e ti dirigi all’interno del cerchio con la tua nuova spada laser per prevenire l’attacco di qualche creatura originaria del pianeta\n" + 
	...
	protected void setAnswer() {
		...
		answer[0][1]="Appena avete messo piede nella grotta un enorme Scavasabbia emerge con rapidità e forza inaudita dalle dune e ha inghiottito te e i tuoi compagni uccidendovi.";
		answer[0][2]="Vi si sono ghiacciate e le mani non riuscendo più a tenere la tua spada e sei stata uccisa e mangiata da un Wampa, creatura enorme dai denti affilati, con 2 corna ricurve e pelliccia bianca.";
		answer[0][3]="All’interno della grotta ci sono una ventina di pipistrelli suicidi dormienti, essi sono conosciuti per avere nello stomaco una sostanza esplosiva che attivano quando si sentono in pericolo. Li uccidete tutti senza problemi.";
		answer[1][0]="La tua trappola è stata in grado di uccidere il drago Krayt che si trovava in fondo al canyon. Sei scesa insieme agli altri e con le vostre spade aprite lo stomaco del drago recuperando abbastanza perle per tutti";
		answer[1][1]="L’esplosione crea un turbine di sabbia che ti entra negli occhi costrigendoti a chiuderli. Dal terreno emerge uno Scavasabbia che ti attacca. Sei morta!";
		answer[1][2]="Arrivi in una zona talmente ghiacciata che ti si congelano mani e piedi, rimani immobile e all’improvviso avvisti un Wampa inferocito, che corre nella tua direzione. Sei morta!";
		...
		answer[2][0]="Mentre ti dirigevi con la spada laser nel cerchio hai per sbaglio danneggiato una pianta che componeva la natura circostante e, non lasciandoti neanche il tempo di un respiro, una gigantesca pianta carnivora ti ha inghiottita. Sei morta.";
		answer[2][1]="Le piante che formavano il cerchio si aprono per permetterti il passaggio per poi chiudersi di nuovo una volta entrata. Iniziata la meditazione capisci immediatamente che qualsiasi altra azione, se avventata,\n"
				+ " avrebbe potuto scaturire la tua morte e quella dei tuoi compagni,\n"
				+ " in quanto la stessa natura vi avrebbe ucciso pur di mantenere il pianeta integro. Continuando la tua meditazione, riesci sempre più a sentire la forza scorrere dentro di te e negli organismi circostanti,\n"
				+ " fino a quando senti le piante dietro di te aprirsi di nuovo come segno di completamento e ti dirigi di nuovo alla nave.";
		answer[2][2]="All’ingresso del cerchio tu e il tuo compagno, mentre provavate ad entrare, nell’arco di tempo di mezzo secondo, sono cresciute delle lunghe spine che vi hanno trafitto e ucciso.";
		answer[2][3]="Hai sbagliato il lancio colpendo una creatura originaria del posto che si è sentita immediatamente minacciata e con un ruggito ha fatto smuovere tutta la natura attorno a voi facendovi attaccare e uccidere da essa.";
		...
		answer[4][3]="Mentre l’attenzione del Nexu era rivolta su di te hai richiamato la spada facendola conficcare nella testa del Nexu uccidendolo.\n"
				...
				+ "ad aiutare gli altri compagni ancora alle prese con la battaglia. Alcuni maestri si avvicinano per congratularsi con te che sei riuscita nella pazza impresa, \n"
				+ "spiegandoti anche che fingere che fosse un’impresa mortale anziché completamente monitorata era l’unica scelta per allenare velocemente da 0 nuove reclute \n"
	...
	protected void setTrama() {
		...
		this.trama="Ci troviamo nel 17ABY con una situazione interstellare disastrosa per le continue guerre, \n"
				...
				+ " e uscirne vivi per scalare più velocemente i 6 ranghi che compongono il “Jedi Path”: Iniziati, younglings, padawan, cavaliere, maestro e Gran Maestro.\n" + 
